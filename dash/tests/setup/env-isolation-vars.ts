...
export const CLEARED = [
  ...
  'KYBERDASH_COPILOT_SESSION_STORE_DB',
  'KYBERDASH_COPILOT_WS_STORAGE_DIR',
  'KYBERDASH_DESKTOP_SESSIONS_DIR',
  'KYBERDASH_MUX_DIR',
  'KYBERDASH_OPEN_DESIGN_DIR',
  'KYBERDASH_OPENCLAUDE_DIR',
  'KYBERDASH_ANTIGRAVITY_SETTINGS_PATH',
  // codeburn behavior toggles (set by the dev to tweak local runs)
  'KYBERDASH_COPILOT_DISABLE_OTEL',
  'KYBERDASH_TZ',
  'KYBERDASH_VERBOSE',
  'KYBERDASH_CURSOR_MAX_BUBBLES',
  'KYBERDASH_FORCE_MACOS_MAJOR',
