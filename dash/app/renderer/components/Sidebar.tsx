...
export function Sidebar({
  ...
  return (
    <>
      <nav className="sb">
        <div className="app"><FlameMark size={20} live /><b>KyberDash</b></div>
        {NAV_ITEMS.map(item => (
          <div
            key={item.id}
