...
import { decideParseWorkers, ParseWorkerPool, parseFilesInOrder, type ClaudeWorkerParse } from './parse-workers.js'
import { clearSessionCache, parseAllSessions, parseClaudeFileFull } from './parser.js'
import { parseCodexFileFull, type CodexFullParse } from '../providers/codex.js'
...
async function codexResults(cacheDir: string): Promise<string | null> {
  const { codexCacheFileName } = await import('./codex-cache.js')
