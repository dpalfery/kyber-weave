  ...
  it('parses current Antigravity CLI SQLite conversations with non-zero token usage', async () => {
    ...
    try {
      const fixture = JSON.parse(await readFile(
        new URL('../../tests/fixtures/antigravity-cli-current/gen-metadata.json', import.meta.url),
        'utf-8',
      ...
      await writeFile(
        ...
        await readFile(
          new URL(
            '../../tests/fixtures/antigravity-cli-current/brain/fixture-current-cli/.system_generated/logs/transcript.jsonl',
            import.meta.url,
          ),
          'utf-8',
        ),
