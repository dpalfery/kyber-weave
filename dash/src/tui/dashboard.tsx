...
import { parseAllSessions, filterProjectsByDateRange, filterProjectsByName, setInteractiveScanUI, withSinglePassParse, withColdFirstPaintFloor, filesParsedFromSourceCount, isCompleteSessionSnapshotAvailable } from '../ingest/parser.js'
import { findUnpricedModels, isExpectedFreeModel, loadPricing } from '../pricing/models.js'
import { aggregateModelTotals } from '../metrics/model-breakdown.js'
import { buildDurableOverviewFromNormalizedIndex, buildDurablePeriod, hydrateDailyCacheFromNormalizedProjects } from '../metrics/usage-aggregator.js'
import { loadDailyCache, type DailyCache } from '../ingest/daily-cache.js'
import { exitAfterCacheCleanup } from '../ingest/session-cache.js'
import { getAllProviders } from '../providers/index.js'
import { classHeaderLine, classTotals, findingBasis, findingClass, scanAndDetect, type FindingClass, type WasteFinding, type WasteAction, type OptimizeResult } from '../metrics/optimize.js'
import { appliedFixGlyph, formatAppliedFix, type AppliedFix } from './act/types.js'
import { aggregateFileChurn, buildCoachingNotes, computePricingCoverage, medianTimeToFirstEditMs, scanUserCorrections, worstOneShotCategory, type ReworkedFile } from '../metrics/workflow-insights.js'
import { estimateContextBudget, type ContextBudget } from '../metrics/context-budget.js'
...
import { formatDayRangeLabel, getDateRange, parseDayFlag, PERIODS, PERIOD_LABELS, shiftDay, type Period } from '../cli/cli-date.js'
