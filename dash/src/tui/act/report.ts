...
import {
  ...
  type WasteFinding,
} from '../../metrics/optimize.js'
import { parseAllSessions } from '../../ingest/parser.js'
import { computeYield, type YieldSummary } from '../../metrics/yield.js'
...
async function modelDefaultRow(
  ...
  const { aggregateModelStats } = await import('../../metrics/compare-stats.js')
