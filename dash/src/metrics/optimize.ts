...
import { isReadShapedBashCommand } from '../ingest/bash-utils.js'
import { readSessionLines, readSessionFileSync } from '../ingest/fs-utils.js'
import { discoverAllSessions, providerDisplayName } from '../providers/index.js'
import { parseJsonlLine, shouldSkipLine } from '../ingest/parser.js'
import type { DateRange, ProjectSummary, SessionSummary } from '../types.js'
import { formatCost } from '../format.js'
import { formatTokens } from '../format.js'
import { recommendModelDefault, type ModelDefaultRecommendation } from '../tui/act/model-defaults.js'
import { appliedFixGlyph, formatAppliedFix, type AppliedFix } from '../tui/act/types.js'
import { isUserStartedSession, userStartedProjects } from '../ingest/session-population.js'
