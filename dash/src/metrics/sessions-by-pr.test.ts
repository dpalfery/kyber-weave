...
import { aggregateByPr, allocateEven, attributeSessionPrSpend, prLinkedTotals, shortenPrUrl } from './sessions-report.js'
import type { ClassifiedTurn, ParsedApiCall, ProjectSummary, SessionSummary, TokenUsage } from '../types.js'
...
describe('shortenPrUrl', () => {
  it('shortens GitHub PR URLs and passes anything else through', () => {
    expect(shortenPrUrl('https://github.com/dpalfery/kyber-weave/pull/755')).toBe('dpalfery/kyber-weave#755')
