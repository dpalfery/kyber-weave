...
internal static class SquadCommandComposition
{
    ...
    /// files. Copilot, Cursor, and Codex are native; Antigravity is fallback role-skill lowering
    ...
    public static ISquadRenderer ResolveRenderer() =>
        new SquadRendererRegistry([new CopilotRenderer(), new CursorRenderer(), new AntigravityRenderer(), new CodexRenderer()]);
