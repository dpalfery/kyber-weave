...
for eight currently implemented and registered renderers: `copilot`, `cursor`, `claude`, `codex`,
`antigravity`, `opencode`, `kilo`, and `pi`. The product declares two more targets—`warp` and
