...
and registered today: `copilot`, `cursor`, `claude`, `codex`, `antigravity`, `opencode`, and `warp`. The other two
declared targets—`kilo` and `factory`—fail renderer-coverage preflight.
