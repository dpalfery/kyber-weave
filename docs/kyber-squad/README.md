...
|---|---|---|
| **Canonical AgentIR Compilation** | Single source of truth: compiles 22 canonical agents and 26 skills to 10 harness targets without manual reformatting. | `kyber-weave squad install` |
