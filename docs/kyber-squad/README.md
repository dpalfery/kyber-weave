...
|---|---|---|
| **Canonical AgentIR Compilation** | Single source of truth: compiles 23 canonical agents and 25 skills to 10 native harness targets without manual reformatting. | `kyber-weave squad install` |
