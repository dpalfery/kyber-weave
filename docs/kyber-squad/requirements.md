...
|---|---|
| **KS-001** | **Canonical Source Governance**: Maintain exactly 23 canonical agent instruction bodies and 25 canonical skill source directories under `products/kyber-squad/`. Generated role-skill projections do not alter the source inventory, and generated APM, plugin, or harness trees are never tracked in source control. |
