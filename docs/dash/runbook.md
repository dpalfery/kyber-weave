...
**two local execution surfaces** today; a Tauri tray for macOS and Windows is being built
under the [context surfaces specification](../specs/kyberdash-context-surfaces/README.md):
