...
| [0020](0020-zcode-command-lowering-and-resource-relocation.md) | [ZCode Lowers the Primary Agent to a Slash Command and Relocates Agent Resources](0020-zcode-command-lowering-and-resource-relocation.md) | Accepted | 2026-09-21 | ZCode's conductor lowers to `/conductor` at `.zcode/commands/`, and agent resources move under `.zcode/skills/` with rewritten links because the agent and command roots are scanned recursively. |
