...
| KyberDash | Feature | `dash` | Local interactive dashboard consuming OpenTelemetry data from .NET Aspire to observe, analyze, and tune agentic context windows. | [dash/README.md](dash/README.md) · [dash/runbook.md](dash/runbook.md) (Interactive multi-surface dashboard) | dpalfery | 2026-09-03 | draft |
