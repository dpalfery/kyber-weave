...
| [factory.md](factory.md) | KyberSquad | superseded | Add a native Factory (factory-droids) renderer to Kyber-Squad (superseded by [plan](../plans/2026-09-14-factory-native-renderer.md)). |
