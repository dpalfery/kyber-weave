...
| [squad-path-argument-safety.md](squad-path-argument-safety.md) | KyberSquad | superseded | `squad` commands' positional path argument could silently target the wrong directory (superseded by [plan](../plans/2026-09-23-squad-path-argument-safety.md); delivery in flight on PR #113). |
